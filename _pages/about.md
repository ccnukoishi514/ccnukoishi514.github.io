...
你好！我是朱正道，目前在华中师范大学攻读数字媒体技术专业。我拥有扎实的数学与算法基础，并且对探索前沿的人工智能技术有着浓厚的兴趣。

我的研究方向主要聚焦于**计算机视觉、图像处理以及AI4S**。在过去的科研经历中，我致力于通过深度学习技术解决实际场景中的复杂问题：

**医学图像配准**：目前，我正在上海交通大学科研实习。我主要基于PyTorch框架，针对 VoxelMorph 与 TransMorph 等经典网络开展新型感知相似性度量函数的应用与优化研究，旨在突破传统度量函数在图像强度变化和噪声干扰下的局限性。
